...
type Customer struct {
	Uid        string    `json:"uid" gorm:"type:varchar(30);primary_key"`
	...
	CreditCard string    `json:"creditCard" gorm:"type:varchar(20); not null"`
	IsStudent  *bool     `json:"isStudent" gorm:"type:boolean; not null"`
	Telephone  string    `json:"telephone" gorm:"type:varchar(30); not null"`
